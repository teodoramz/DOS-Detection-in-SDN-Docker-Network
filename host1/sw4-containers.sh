...
docker exec dns_collector ip link set eth1  mtu 1400 
...
docker exec sw4 ip link set eth_dcol2  mtu 1400 
...
docker exec proxy_collector ip link set eth1  mtu 1400 
...
docker exec sw4 ip link set eth_pcol2  mtu 1400 
...
docker exec web_collector ip link set eth1  mtu 1400 
...
docker exec sw4 ip link set eth_scol2  mtu 1400 